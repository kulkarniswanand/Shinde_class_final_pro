...
const StaffManagement = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      // WhatsApp logic
      const whatsappMessage = `Staff details updated successfully:\nName: ${formData.name}\nDesignation: ${formData.designation}\nBranch: ${formData.branch}\nContact: ${formData.contact}\nEmail: ${formData.email}}`;
    ...
    <div className="container mx-auto p-6 bg-gradient-to-r from-blue-900 via-purple-900 to-black min-h-screen text-white relative">
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center space-x-4">
          <select
            ...
            className="p-3 border rounded-lg bg-gray-800 text-white focus:ring-2 focus:ring-yellow-500"
          >
        ...
        <button
          ...
          className="bg-gradient-to-r from-green-400 to-blue-500 hover:from-blue-500 hover:to-green-400 text-white px-6 py-3 rounded-lg shadow-lg transition duration-300"
        >
          New Staff
        </button>
      </div>
      ...
      <div className="overflow-x-auto shadow-lg rounded-lg">
        <table className="w-full border-collapse border border-gray-700 bg-gray-900 text-white">
          <thead className="bg-gradient-to-r from-purple-700 to-blue-700 text-yellow-300 text-center">
            <tr>
                ...
                <td className="p-4 border">
                  <div className="flex flex-col space-y-2">
                    <button
                      ...
                      className="bg-gradient-to-r from-green-400 to-teal-400 hover:from-teal-400 hover:to-green-400 text-white px-4 py-2 rounded-lg shadow-md transition duration-300"
                    >
                      Update
                    </button>
                    <button
                      onClick={() => setDeleteStaffId(staff.id)}
                      className="bg-gradient-to-r from-red-400 to-pink-400 hover:from-pink-400 hover:to-red-400 text-white px-4 py-2 rounded-lg shadow-md transition duration-300"
                    >
                      Delete
                    </button>
                  </div>
      ...
      {editStaff && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-1/2">
            <h2 className="text-2xl font-semibold mb-4 text-yellow-400">Edit Staff</h2>
      ...
      {deleteStaffId && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-1/3">
            <h2 className="text-2xl font-semibold mb-4 text-yellow-400">Confirm Delete</h2>
