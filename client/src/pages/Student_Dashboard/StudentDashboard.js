...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (storedUsername) setStudentName(storedUsername);
      ...
      <div className="flex justify-between items-center px-10">
        ...
        <div className="relative">
          ...
          {isProfileMenuOpen && (
            ...
            >
              <p className="px-4 py-2 hover:bg-gray-600 hover:text-white cursor-pointer">View Profile</p>
              <p className="px-4 py-2 hover:bg-gray-600 hover:text-white cursor-pointer" onClick={handleLogout}>Logout</p>
            </div>
          )}
        </div>
      </div>
